...
- Se añadieron endpoints mock de carrito y pedidos (`wc/store/v1/cart`, `wc/v3/orders`, `wc/v3/orders/{id}`) para reducir warnings y permitir checkout local sin backend real.
